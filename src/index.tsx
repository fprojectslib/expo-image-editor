    ...
    return (<>
      ...
      {processing && <Processing customComponent={processingComponent}/>}
        <View style={styles.tipsContainer}>
            <Text style={styles.tipsHeader}>For best results:</Text>
            <Text style={styles.tips}>- Make sure the image contains only one clothing item.</Text>
            <Text style={styles.tips}>- Make sure no person is in the image.</Text>
            <Text style={styles.tips}>- Make sure the clothing item is centered.</Text>
            <Text style={styles.tips}>- Ensure good lighting and clear image with upright orientation.</Text>
        </View>
    </>);
}
